...
const PLANS: Plan[] = [
  {
    ...
    unit: "VND",
    cycle: "/ 14 ngày",
    target: "Giảm rào cản tiếp cận — không cần thẻ tín dụng",
    badge: null,
    glow: false,
    accent: "emerald",
    ...
    features: [
      { text: "1 chiến dịch phishing mẫu" },
      { text: "Khóa học nền tảng bảo mật cơ bản" },
      { text: "Báo cáo kết quả cá nhân" },
      { text: "Tối đa 5 người dùng" },
    ],
  },
  {
    id: "individual",
...
const FAQS = [
  {
    ...
    a: "Có. AntiPhisher không ràng buộc hợp đồng dài hạn. Bạn có thể hủy hoặc thay đổi gói vào bất kỳ thời điểm nào — quyền lợi vẫn được giữ nguyên đến hết chu kỳ thanh toán hiện tại.",
  },
  {
    q: "Tôi có thể nâng cấp từ Free lên gói trả phí như thế nào?",
    a: "Chỉ cần vào Cài đặt tài khoản → Quản lý gói → Chọn gói mới. Hệ thống sẽ tính toán phần chênh lệch theo ngày và thanh toán qua cổng VNPay hoặc thẻ quốc tế.",
  },
  {
    q: "Dữ liệu nhân viên của tôi có được bảo mật không?",
    a: "Toàn bộ dữ liệu được mã hóa AES-256 khi lưu trữ và TLS 1.3 khi truyền tải. Chúng tôi tuân thủ Nghị định 13/2023/NĐ-CP về bảo vệ dữ liệu cá nhân tại Việt Nam và không bán dữ liệu cho bên thứ ba.",
  },
  {
    q: "Gói PRO có hỗ trợ tích hợp với hệ thống HR/Active Directory không?",
    a: "Có. Gói PRO hỗ trợ đồng bộ người dùng qua LDAP/Active Directory, SAML 2.0 SSO, và REST API để tích hợp với hệ thống HR hiện có của doanh nghiệp.",
  },
  {
    q: "Tôi cần bao nhiêu thời gian để onboarding toàn bộ nhân viên?",
    a: "Với doanh nghiệp dưới 50 người, quá trình setup thường mất dưới 2 giờ. Với tổ chức lớn hơn, đội ngũ Customer Success của chúng tôi sẽ hỗ trợ onboarding toàn bộ trong vòng 48 giờ.",
  },
  {
    q: "Báo cáo compliance xuất ra theo định dạng nào?",
    a: "Hỗ trợ xuất PDF có chữ ký số, Excel, và JSON cho các hệ thống SIEM. Báo cáo được cấu trúc theo chuẩn NIST CSF, ISO 27001 Annex A, và PCI DSS có thể tùy chỉnh theo yêu cầu kiểm toán.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <span
            ...
            style={{ color: "#0F172A", fontFamily: "'Be Vietnam Pro', sans-serif" }}
          >
        ...
        <div className="hidden md:flex items-center gap-8">
          {NAV_LINKS.map((link) => (
            <a
              key={link.label}
              href={link.href}
              className="text-sm font-medium transition-colors duration-200 hover:text-slate-200"
              style={{ color: "#64748B" }}
            >
              {link.label}
            </a>
    ...
    >
      ...
      >
        ...
        <span
          className="block"
          style={{
            background: "linear-gradient(135deg, #6366F1 0%, #10B981 60%, #34D399 100%)",
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 mb-16">
        <button
          onClick={onLogin}
          className="inline-flex items-center gap-2 px-8 py-4 rounded-xl font-bold text-base transition-all duration-200 active:scale-95"
          style={{
            background: "linear-gradient(135deg, #6366F1, #4F46E5)",
            color: "#fff",
            boxShadow: "0 0 30px rgba(99,102,241,0.45), inset 0 1px 0 rgba(255,255,255,0.15)",
          }}
        >
        ...
        <button
          className="inline-flex items-center gap-2.5 px-7 py-4 rounded-xl font-semibold text-base transition-all duration-200"
          style={{
      ...
      <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-6 max-w-3xl w-full">
        {STATS.map((stat) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[11px] text-center leading-snug" style={{ color: "#94A3B8" }}>
                {stat.label}
              </span>
            </div>
          );
      ...
      <div className="relative z-10 mt-16 flex flex-col items-center gap-2" style={{ color: "#CBD5E1" }}>
        <span className="text-[11px] tracking-widest uppercase">Khám phá</span>
    ...
    <section id="features" className="py-28 px-6" style={{ background: "#F8FAFF" }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-xs font-bold tracking-[0.3em] uppercase mb-3" style={{ color: "#6366F1" }}>
            AI Core
          </p>
          <h2
          ...
          {AI_FEATURES.map((feat, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="inline-block text-[10px] font-bold tracking-widest uppercase mb-2 px-2 py-0.5 rounded"
...
function BenefitsSection({ onLogin }: { onLogin: () => void }) {
  return (
    <section id="benefits" className="py-28 px-6 relative overflow-hidden" style={{ background: "#F0F4FF" }}>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <p className="text-xs font-bold tracking-[0.3em] uppercase mb-3" style={{ color: "#10B981" }}>
            Social Proof
          </p>
          <h2
            className="text-4xl md:text-5xl font-extrabold mb-4"
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(245,158,11,0.08) 0%, rgba(255,252,240,0.95) 100%)",
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left">
            <h3
              ...
              style={{ color: "#92400E", fontFamily: "'Be Vietnam Pro', sans-serif" }}
            >
          ...
          <button
            onClick={onLogin}
            className="shrink-0 inline-flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm transition-all duration-200 whitespace-nowrap hover:bg-amber-500/20"
            style={{
  ...
  return (
    <section id="pricing" className="py-28 px-6 relative" style={{ background: "#F8FAFF" }}>
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        ...
        />
        <div
          className="absolute -bottom-24 -right-24 w-[600px] h-[600px] rounded-full opacity-10"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 max-w-2xl mx-auto">
          <p className="text-xs font-bold tracking-[0.35em] uppercase mb-3" style={{ color: "#6366F1" }}>
            Chiến lược định giá
          </p>
          <h2
          ...
          <p className="text-sm font-semibold tracking-widest uppercase mb-5" style={{ color: "#94A3B8" }}>
            Tiered PaaS Model
          </p>
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: plan.glow
                    ...
                    : isHovered
                    ? "0 0 32px rgba(99,102,241,0.1), 0 1px 4px rgba(99,102,241,0.06)"
              ...
              >
                {plan.badge && (
                  <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-10">
                    <span
                      className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold tracking-[0.2em] uppercase whitespace-nowrap"
                      style={{
                ...
                <div className="flex flex-col flex-1 p-7 pt-8">
                  <div className="mb-5">
                    <p className={`text-[11px] font-bold tracking-[0.28em] uppercase mb-1 ${accent.tierText}`}>
                      {plan.tier}
                    </p>
                  ...
                  <div className="mb-1 flex items-end gap-1">
                    <span className="text-3xl font-extrabold leading-none" style={{ color: "#0F172A", letterSpacing: "-0.03em" }}>
                      {plan.price}
                    </span>
                  ...
                  <p className="text-xs leading-relaxed mb-5 italic" style={{ color: "#94A3B8" }}>
                    {plan.target}
                  </p>
                  ...
                  <ul className="flex flex-col gap-3 flex-1 mb-7">
                    {plan.features.map((feat, idx) => (
                      <li key={idx} className="flex items-start gap-2.5 text-sm" style={{ color: "#64748B" }}>
                        <span className={`mt-0.5 shrink-0 ${accent.tierText}`}>
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-base" style={{ color: "#94A3B8" }}>
            Mọi thứ bạn cần biết về chính sách, bảo mật và tích hợp.
          </p>
        </div>
...
function Footer({ onLogin }: { onLogin: () => void }) {
  return (
    <footer
      ...
      style={{ background: "#EEF2FF", borderTop: "1px solid rgba(99,102,241,0.08)" }}
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <button
          onClick={onLogin}
          className="text-sm font-bold px-5 py-2.5 rounded-lg transition-all duration-200 active:scale-95"
          style={{
            background: "linear-gradient(135deg, #6366F1, #4F46E5)",
            color: "#fff",
